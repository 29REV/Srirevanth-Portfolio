...
export default function HeroSection() {
  ...
  const fullTitle = 'Cybersecurity Engineer · Full-Stack · AI Systems';
  ...
  const handleCommandSubmit = (e) => {
    ...
    if (cmd === 'help') {
      ...
      newLogs.push({ type: 'res', text: 'Sri Revanth A - Cyber Security Engineer & Backend Specialist (B.E @ Dr.NGPIT, CGPA: 8.25)' });
  ...
  return (
    <section id="hero" className="relative min-h-screen pt-28 pb-16 flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-emerald-500/10 rounded-full blur-[140px] pointer-events-none"></div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          >
            ...
            <div className="relative group w-72 sm:w-80 lg:w-88">
              ...
              <div className="absolute -inset-4 rounded-3xl bg-gradient-to-r from-emerald-500 via-cyan-500 to-teal-400 opacity-30 blur-lg group-hover:opacity-50 transition-opacity animate-pulse-glow"></div>
              
              {/* HUD Card Container */}
              <div className="relative rounded-2xl bg-[#0b0f19] border border-emerald-500/40 p-4 shadow-2xl overflow-hidden backdrop-blur-xl">
                ...
                <div className="relative rounded-xl overflow-hidden border border-emerald-500/30 group-hover:border-emerald-400 transition-colors">
                  ...
                  <div className="absolute bottom-3 left-3 right-3 flex items-center justify-between font-mono text-[11px] bg-[#030712]/90 border border-emerald-500/30 backdrop-blur-md px-3 py-2 rounded-lg">
